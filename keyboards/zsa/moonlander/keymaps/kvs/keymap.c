...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LEFT] = LAYOUT(
		...
		_______,   KC_EXLM,   KC_AT,     KC_HASH,   KC_DLR,    KC_PERC,   _______,   _______,   KC_PERC,   KC_AMPR,   KC_ASTR,   KC_LPRN,   KC_RPRN,   KC_F12,    
		...
		EE_CLR,    _______,   _______,   _______,   _______,                         RM_VALU,   RM_TOGG,   _______,   KC_DOT,    KC_0,      KC_EQL,    _______,   
		                                                   _______, _______, _______, RM_PREV, RM_NEXT, _______                                                   
    ),

    [RIGHT] = LAYOUT(
		_______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   QK_BOOT,   
		_______,   KC_1,      KC_2,      KC_3,      KC_4,      KC_5,      _______,   _______,   KC_6,      KC_7,      KC_8,      KC_9,      KC_0,      _______,   
		_______,   KC_GRV,    KC_MS_L,   KC_MS_D,   KC_MS_R,   _______,   _______,   _______,   _______,   KC_MINUS,  KC_EQUAL,  _______,   _______,   KC_MPLY,   
		_______,   _______,   _______,   _______,   _______,                         _______,   _______,   _______,   KC_MPRV,   KC_MNXT,   _______,   _______,   
		_______,   _______,   _______,   KC_BTN1,   KC_BTN2,                         _______,   _______,   KC_VOLU,   KC_VOLD,   KC_MUTE,   _______,   _______,   
		                                                   _______, RM_VALU, RM_VALD, RM_SPDD, RM_SPDU, _______                                                   
    ),
};
